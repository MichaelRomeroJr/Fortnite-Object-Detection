...
#Detection phase  
videofile = "C:/FortniteClip.mp4" #or path to the video file.
cap = cv2.VideoCapture(videofile)  
#cap = cv2.VideoCapture(0)  #for webcam

#StreamFromMonitor.run()
#videofile = "C:/Users/micha/OneDrive/Desktop/Video.avi" #or path to the video file.
#cap = cv2.VideoCapture(videofile) 
